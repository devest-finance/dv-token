                ...
                describe('when the spender has enough allowance', function () {
                    ...
                    describe('when the token owner has enough balance', function () {
                        ...
                        it('transfers the requested amount', async function () {
                            ...
                            const t = await this.token.balanceOf(to);
    ...
    describe('when the recipient is not the zero address', function () {
        ...
        describe('when the sender transfers all balance', function () {
            ...
            it('transfers the requested amount', async function () {
                ...
                expect(await this.token.balanceOf(to)).to.be.bignumber.equal(amount.sub(new BN('1000')));
                //expect(await this.token.balanceOf("0x09192953128258866E7F2CB473A539e73Ac4511c")).to.equal(new BN('1000'));
            });
